  ...
  return (
    <div className='container mx-auto py-2 px-6 md:px-4'>
      <div className='flex  justify-between items-center'>
        <div>
            <h2 className='text-[#f5f5f5] font-semibold text-xl'>Overall Performance</h2>
            <p className='texm-sm text-[#ababab]'>Lorem ipsum dolor sit amet,   error nam magnam praesentium.</p>
        </div>
      ...
      <div className='flex flex-col justify-between  mt-12'>
        <div>
            <h2 className='text-[#f5f5f5] font-semibold text-xl'>Item Details</h2>
            <p className='texm-sm text-[#ababab]'>Lorem ipsum dolor sit amet,   error nam magnam praesentium.</p>
        </div>
        <div className='mt-6 grid grid-cols-4 gap-4 '>
            {
